...
namespace CliClientWithMessageQueue
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var client = new SignalRClientWithMessageQueue(connection, name);
        ...
        private static async Task Disconnect(SignalRClientWithMessageQueue client)
        {
